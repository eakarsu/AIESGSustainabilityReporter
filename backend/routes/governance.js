...
const TABLE = 'governance_compliance';
const COLUMNS = [
  'policy_name', 'category', 'compliance_level', 'last_review_date',
  'next_review_date', 'responsible_officer', 'violations_count',
  'training_completion_pct', 'risk_rating', 'status'
];
