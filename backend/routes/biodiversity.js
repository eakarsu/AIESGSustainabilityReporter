...
const TABLE = 'biodiversity_impacts';
const COLUMNS = [
  'project_name', 'location', 'ecosystem_type', 'species_affected',
  'habitat_area_hectares', 'impact_type', 'mitigation_measures',
  'biodiversity_score', 'monitoring_frequency', 'status'
];
