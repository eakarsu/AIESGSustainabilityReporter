...
const TABLE = 'water_usage';
const COLUMNS = [
  'facility_name', 'location', 'water_source', 'consumption_cubic_meters',
  'discharge_cubic_meters', 'recycled_pct', 'water_stress_level',
  'quality_index', 'reduction_target_pct', 'status'
];
