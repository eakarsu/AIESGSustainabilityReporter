...
const TABLE = 'energy_audits';
const COLUMNS = [
  'facility_name', 'audit_date', 'total_consumption_kwh', 'renewable_pct',
  'efficiency_rating', 'carbon_intensity', 'cost_per_kwh', 'annual_cost',
  'savings_potential_pct', 'recommendations', 'status'
];
